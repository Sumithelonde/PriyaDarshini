...
import { UserCircle2, LogOut, FileText, Phone, Mail, Clock, CheckCircle2, AlertCircle, Scale, TrendingUp, Briefcase, Users } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl sm:text-3xl font-bold text-foreground">Lawyer Dashboard</h1>
            </div>
              ...
              {profileOpen && (
                <div className="absolute right-0 top-full mt-2 w-72 rounded-2xl border border-border/60 bg-card/80 backdrop-blur-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 supports-[backdrop-filter]:bg-card/40">
                  ...
                  <div className="px-4 py-4 border-b border-border/50 bg-muted/20 backdrop-blur-sm">
                    <p className="text-sm font-semibold text-foreground">Lawyer Profile</p>
                    {loadingUser ? (
                      ...
                      <div className="mt-3 space-y-2">
                        ...
                        <div>
                          ...
                          <Badge className="mt-1 bg-primary text-primary-foreground">{userInfo?.role || 'Lawyer'}</Badge>
                        </div>
                      </div>
                    )}
                  </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <div className="grid gap-4 md:grid-cols-2 mb-8">
          ...
          <Card className="rounded-2xl border border-border/50 bg-card/40 p-6 backdrop-blur-2xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 supports-[backdrop-filter]:bg-card/30">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground font-medium">Pending Cases</p>
                  ...
                  <CardContent className="space-y-4">
                    {req.case_type && (
                      <div className="p-3 rounded-lg bg-muted/30 backdrop-blur-sm border border-border/50">
                        <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Case Type</p>
                        <p className="text-sm text-foreground">{req.case_type}</p>
                      </div>
                    )}
